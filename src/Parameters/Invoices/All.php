...
class All implements Parameter
{
    ...
    public function orderByInvoicenumberAsc(bool $expand = true): self
    {
        $this->orderByField('invoicenumber', true);
        return $this;
    }

    public function orderByInvoicenumberDesc(bool $expand = true): self
    {
    ...
    public function orderByInvoicenumber_fullAsc(bool $expand = true): self
    {
        $this->orderByField('invoicenumber_full', true);
        return $this;
    }

    public function orderByInvoicenumber_fullDesc(bool $expand = true): self
    {
