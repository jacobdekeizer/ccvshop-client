...
class QuotationStatus implements Model
{
    use FromArray;
    use ToArray;
    ...
    /**
     * @var string This status corresponse with the status in the quotation resource.
     */
    private $status;
    ...
    /**
     * @return string This status corresponse with the status in the quotation resource.
     */
    ...
    /**
     * @param string $status This status corresponse with the status in the quotation resource.
     * @return self
     */
