...
class OrderStatus implements Model
{
    ...
    /**
     * @var int Id of the status. This is also visilbe in the order resource.
     */
    private $id;
    
    /**
     * @var string This status corresponse with the status in the order resource.
     */
    private $status;
    ...
    /**
     * @return int Id of the status. This is also visilbe in the order resource.
     */
    ...
    /**
     * @return string This status corresponse with the status in the order resource.
     */
    ...
    /**
     * @param int $id Id of the status. This is also visilbe in the order resource.
     * @return self
     */
    ...
    /**
     * @param string $status This status corresponse with the status in the order resource.
     * @return self
     */
