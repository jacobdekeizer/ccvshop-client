...
namespace JacobDeKeizer\Ccv\Models\Vnd\Verto\Webshop\Entity\Settings;
...
class Settings implements Model
{
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Vnd\Verto\Webshop\Entity\Settings\Child\StockLevelWarnings Describes the stock level thresholds. Typically if a product's stock is above high it's 'green'. Is it below low it's 'red'. In between would be considered 'orange'.
     */
    public function getStockLevelWarnings(): \JacobDeKeizer\Ccv\Models\Vnd\Verto\Webshop\Entity\Settings\Child\StockLevelWarnings
    {
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Vnd\Verto\Webshop\Entity\Takeoutsettings\Takeoutsettings|null Contains takeout settings for this webshop
     */
    public function getTakeoutsettings(): ?\JacobDeKeizer\Ccv\Models\Vnd\Verto\Webshop\Entity\Takeoutsettings\Takeoutsettings
    {
        return $this->takeoutsettings;
    }

    /**
     * @return \JacobDeKeizer\Ccv\Models\Vnd\Verto\Webshop\Entity\Settings\Child\QuotationStatus[]|null An array of all possible status.
     */
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Vnd\Verto\Webshop\Entity\Settings\Child\OrderStatus[]|null An array of all possible status.
     */
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Vnd\Verto\Webshop\Entity\Settings\Child\InvoiceStatus[]|null An array of all possible status.
     */
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Vnd\Verto\Webshop\Entity\Settings\Child\ReturnStatus[]|null An array of all possible status.
     */
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Vnd\Verto\Webshop\Entity\Settings\Child\ParentItem|null Contains link to parent resource.
     */
    public function getParent(): ?\JacobDeKeizer\Ccv\Models\Vnd\Verto\Webshop\Entity\Settings\Child\ParentItem
    {
        return $this->parent;
    }
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Vnd\Verto\Webshop\Entity\Settings\Child\StockLevelWarnings $stockLevelWarnings Describes the stock level thresholds. Typically if a product's stock is above high it's 'green'. Is it below low it's 'red'. In between would be considered 'orange'.
     * @return self
     */
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Vnd\Verto\Webshop\Entity\Takeoutsettings\Takeoutsettings|null $takeoutsettings Contains takeout settings for this webshop
     * @return self
     */
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Vnd\Verto\Webshop\Entity\Settings\Child\ParentItem|null $parent Contains link to parent resource.
     * @return self
     */
