...
class Orderaffiliatenetworks implements Model
{
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Vnd\Verto\Webshop\Resource\Orderaffiliatenetworks\Orderaffiliatenetworks[]|null $items Array with collection items
     * @return self
     */
    ...
    protected function convertFromArrayData(string $key, $value)
    {
        if ($key === 'items') {
            ...
            foreach ($value as $item) {
                $items[] = \JacobDeKeizer\Ccv\Models\Vnd\Verto\Webshop\Resource\Orderaffiliatenetworks\Orderaffiliatenetworks::fromArray($item);
            }
