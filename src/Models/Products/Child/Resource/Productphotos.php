...
class Productphotos implements Model
{
    ...
    /**
     * @var \JacobDeKeizer\Ccv\Models\Products\Resource\Productphotos[] Array with collection items
     */
    private $collection;
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Products\Resource\Productphotos[] Array with collection items
     */
    ...
    protected function convertFromArrayData(string $key, $value)
    {
        if ($key === 'collection') {
            ...
            foreach ($value as $item) {
                $items[] = \JacobDeKeizer\Ccv\Models\Products\Resource\Productphotos::fromArray($item);
            }
