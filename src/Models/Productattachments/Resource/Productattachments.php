...
namespace JacobDeKeizer\Ccv\Models\Productattachments\Resource;
...
class Productattachments implements Model
{
     ...
     */
    public function getParent(): ?\JacobDeKeizer\Ccv\Models\Productattachments\Child\Resource\ParentItem
    {
        return $this->parent;
    }
     ...
     * @return self
     */
    public function setParent(?\JacobDeKeizer\Ccv\Models\Productattachments\Child\Resource\ParentItem $parent): self
    {
        $this->parent = $parent;
