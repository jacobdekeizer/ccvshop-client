...
namespace JacobDeKeizer\Ccv\Models\Productvideos\Resource;
...
class Productvideos implements Model
{
     ...
     */
    public function getParent(): ?\JacobDeKeizer\Ccv\Models\Productvideos\Child\Resource\ParentItem
    {
        return $this->parent;
    }
     ...
     * @return self
     */
    public function setParent(?\JacobDeKeizer\Ccv\Models\Productvideos\Child\Resource\ParentItem $parent): self
    {
        $this->parent = $parent;
