...
namespace JacobDeKeizer\Ccv\Models\Orderaffiliatenetworks\Collection;
...
class Orderaffiliatenetworks implements Model
{
    ...
    /**
     * @var \JacobDeKeizer\Ccv\Models\Orderaffiliatenetworks\Resource\Orderaffiliatenetworks[]|null Array with collection items
     */
    private $items;
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Orderaffiliatenetworks\Resource\Orderaffiliatenetworks[]|null Array with collection items
     */
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Orderaffiliatenetworks\Resource\Orderaffiliatenetworks[]|null $items Array with collection items
     * @return self
     */
    ...
    protected function convertFromArrayData(string $key, $value)
    {
        if ($key === 'items') {
            ...
            foreach ($value as $item) {
                $items[] = \JacobDeKeizer\Ccv\Models\Orderaffiliatenetworks\Resource\Orderaffiliatenetworks::fromArray($item);
            }
