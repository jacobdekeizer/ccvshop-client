...
namespace JacobDeKeizer\Ccv\Models\Productqueries\Collection;
...
class Products implements Model
{
    ...
    /**
     * @var \JacobDeKeizer\Ccv\Models\Productqueries\Resource\Products[] Array with collection items
     */
    private $items;
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Productqueries\Resource\Products[] Array with collection items
     */
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Productqueries\Resource\Products[] $items Array with collection items
     * @return self
     */
    ...
    protected function convertFromArrayData(string $key, $value)
    {
        if ($key === 'items') {
            ...
            foreach ($value as $item) {
                $items[] = \JacobDeKeizer\Ccv\Models\Productqueries\Resource\Products::fromArray($item);
            }
