...
namespace JacobDeKeizer\Ccv\Models\Productreviews\Collection;
...
class Productreviews implements Model
{
    ...
    /**
     * @var \JacobDeKeizer\Ccv\Models\Productreviews\Resource\Productreviews[] Array with collection items
     */
    private $items;
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Productreviews\Resource\Productreviews[] Array with collection items
     */
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Productreviews\Resource\Productreviews[] $items Array with collection items
     * @return self
     */
    ...
    protected function convertFromArrayData(string $key, $value)
    {
        if ($key === 'items') {
            ...
            foreach ($value as $item) {
                $items[] = \JacobDeKeizer\Ccv\Models\Productreviews\Resource\Productreviews::fromArray($item);
            }
