...
namespace JacobDeKeizer\Ccv\Models\Discountcoupons\Collection;
...
class Discountcoupons implements Model
{
    ...
    /**
     * @var \JacobDeKeizer\Ccv\Models\Discountcoupons\Resource\Discountcoupons[] Array with collection items
     */
    private $items;
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Discountcoupons\Resource\Discountcoupons[] Array with collection items
     */
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Discountcoupons\Resource\Discountcoupons[] $items Array with collection items
     * @return self
     */
    ...
    protected function convertFromArrayData(string $key, $value)
    {
        if ($key === 'items') {
            ...
            foreach ($value as $item) {
                $items[] = \JacobDeKeizer\Ccv\Models\Discountcoupons\Resource\Discountcoupons::fromArray($item);
            }
