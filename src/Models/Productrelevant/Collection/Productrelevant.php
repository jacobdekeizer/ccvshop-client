...
class Productrelevant implements Model
{
    ...
    /**
     * @var \JacobDeKeizer\Ccv\Models\Productqueries\Resource\Productrelevant[] Array with collection items
     */
    private $items;
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Productqueries\Resource\Productrelevant[] Array with collection items
     */
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Productqueries\Resource\Productrelevant[] $items Array with collection items
     * @return self
     */
    ...
    protected function convertFromArrayData(string $key, $value)
    {
        if ($key === 'items') {
            ...
            foreach ($value as $item) {
                $items[] = \JacobDeKeizer\Ccv\Models\Productqueries\Resource\Productrelevant::fromArray($item);
            }
