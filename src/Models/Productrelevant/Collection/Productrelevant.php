...
namespace JacobDeKeizer\Ccv\Models\Productrelevant\Collection;
...
class Productrelevant implements Model
{
    ...
    /**
     * @var \JacobDeKeizer\Ccv\Models\Productrelevant\Resource\Productrelevant[] Array with collection items
     */
    private $items;
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Productrelevant\Resource\Productrelevant[] Array with collection items
     */
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Productrelevant\Resource\Productrelevant[] $items Array with collection items
     * @return self
     */
    ...
    protected function convertFromArrayData(string $key, $value)
    {
        if ($key === 'items') {
            ...
            foreach ($value as $item) {
                $items[] = \JacobDeKeizer\Ccv\Models\Productrelevant\Resource\Productrelevant::fromArray($item);
            }
