...
namespace JacobDeKeizer\Ccv\Models\Usergroups\Collection;
...
class Usergroups implements Model
{
    ...
    /**
     * @var \JacobDeKeizer\Ccv\Models\Usergroups\Resource\Usergroups[] Array with collection items
     */
    private $items;
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Usergroups\Resource\Usergroups[] Array with collection items
     */
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Usergroups\Resource\Usergroups[] $items Array with collection items
     * @return self
     */
    ...
    protected function convertFromArrayData(string $key, $value)
    {
        if ($key === 'items') {
            ...
            foreach ($value as $item) {
                $items[] = \JacobDeKeizer\Ccv\Models\Usergroups\Resource\Usergroups::fromArray($item);
            }
