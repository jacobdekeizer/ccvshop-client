...
namespace JacobDeKeizer\Ccv\Models\Webhooks\Collection;
...
class Webhooks implements Model
{
    ...
    /**
     * @var \JacobDeKeizer\Ccv\Models\Webhooks\Resource\Webhooks[] Array with collection items
     */
    private $items;
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Webhooks\Resource\Webhooks[] Array with collection items
     */
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Webhooks\Resource\Webhooks[] $items Array with collection items
     * @return self
     */
    ...
    protected function convertFromArrayData(string $key, $value)
    {
        if ($key === 'items') {
            ...
            foreach ($value as $item) {
                $items[] = \JacobDeKeizer\Ccv\Models\Webhooks\Resource\Webhooks::fromArray($item);
            }
