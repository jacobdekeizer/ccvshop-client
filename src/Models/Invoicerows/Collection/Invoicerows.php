...
namespace JacobDeKeizer\Ccv\Models\Invoicerows\Collection;
...
class Invoicerows implements Model
{
    ...
    /**
     * @var \JacobDeKeizer\Ccv\Models\Invoicerows\Resource\Invoicerows[]|null Array with collection items
     */
    private $items;
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Invoicerows\Resource\Invoicerows[]|null Array with collection items
     */
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Invoicerows\Resource\Invoicerows[]|null $items Array with collection items
     * @return self
     */
    ...
    protected function convertFromArrayData(string $key, $value)
    {
        if ($key === 'items') {
            ...
            foreach ($value as $item) {
                $items[] = \JacobDeKeizer\Ccv\Models\Invoicerows\Resource\Invoicerows::fromArray($item);
            }
