...
namespace JacobDeKeizer\Ccv\Models\Productvariations\Resource;
...
class Productvariations implements Model
{
    ...
    /**
     * @var \JacobDeKeizer\Ccv\Models\Productvariations\Child\Resource\ParentItem|null Contains link to parent product
     */
    private $parent;
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Productvariations\Child\Resource\ParentItem|null Contains link to parent product
     */
    public function getParent(): ?\JacobDeKeizer\Ccv\Models\Productvariations\Child\Resource\ParentItem
    {
        return $this->parent;
    }
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Productvariations\Child\Resource\ParentItem|null $parent Contains link to parent product
     * @return self
     */
    public function setParent(?\JacobDeKeizer\Ccv\Models\Productvariations\Child\Resource\ParentItem $parent): self
    {
        $this->parent = $parent;
