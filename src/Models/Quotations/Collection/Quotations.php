...
namespace JacobDeKeizer\Ccv\Models\Quotations\Collection;
...
class Quotations implements Model
{
    ...
    /**
     * @var \JacobDeKeizer\Ccv\Models\Quotations\Resource\Quotations[] Array with collection items
     */
    private $items;
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Quotations\Resource\Quotations[] Array with collection items
     */
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Quotations\Resource\Quotations[] $items Array with collection items
     * @return self
     */
    ...
    protected function convertFromArrayData(string $key, $value)
    {
        if ($key === 'items') {
            ...
            foreach ($value as $item) {
                $items[] = \JacobDeKeizer\Ccv\Models\Quotations\Resource\Quotations::fromArray($item);
            }
