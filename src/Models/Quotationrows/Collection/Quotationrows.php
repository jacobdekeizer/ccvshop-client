...
namespace JacobDeKeizer\Ccv\Models\Quotationrows\Collection;
...
class Quotationrows implements Model
{
    ...
    /**
     * @var \JacobDeKeizer\Ccv\Models\Quotationrows\Resource\Quotationrows[] Array with collection items
     */
    private $items;
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Quotationrows\Resource\Quotationrows[] Array with collection items
     */
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Quotationrows\Resource\Quotationrows[] $items Array with collection items
     * @return self
     */
    ...
    protected function convertFromArrayData(string $key, $value)
    {
        if ($key === 'items') {
            ...
            foreach ($value as $item) {
                $items[] = \JacobDeKeizer\Ccv\Models\Quotationrows\Resource\Quotationrows::fromArray($item);
            }
