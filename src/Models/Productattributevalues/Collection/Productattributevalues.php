...
namespace JacobDeKeizer\Ccv\Models\Productattributevalues\Collection;
...
class Productattributevalues implements Model
{
    ...
    /**
     * @var int|null Offset of the set
     */
    private $start;

    /**
     * @var int|null Size of the set
     */
    private $size;
    ...
    /**
     * @var \JacobDeKeizer\Ccv\Models\Productattributevalues\Resource\Productattributevalues[] Array with collection items
     */
    private $items;
    ...
    /**
     * @return int|null Offset of the set
     */
    ...
    /**
     * @return int|null Size of the set
     */
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Productattributevalues\Resource\Productattributevalues[] Array with collection items
     */
    ...
    /**
     * @param int|null $start Offset of the set
     * @return self
     */
    ...
    /**
     * @param int|null $size Size of the set
     * @return self
     */
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Productattributevalues\Resource\Productattributevalues[] $items Array with collection items
     * @return self
     */
    ...
    protected function convertFromArrayData(string $key, $value)
    {
        if ($key === 'items') {
            ...
            foreach ($value as $item) {
                $items[] = \JacobDeKeizer\Ccv\Models\Productattributevalues\Resource\Productattributevalues::fromArray($item);
            }
