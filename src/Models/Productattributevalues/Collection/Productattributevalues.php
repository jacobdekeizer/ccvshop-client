...
class Productattributevalues implements Model
{
    ...
    /**
     * @param int|null Offset of the set
     * @return self
     */
    ...
    /**
     * @param int|null Size of the set
     * @return self
     */
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Productattributevalues\Resource\Productattributevalues[] Array with collection items
     * @return self
     */
