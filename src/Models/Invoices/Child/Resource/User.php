...
class User implements Model
{
    ...
    /**
     * @param int|null Unique id of the user. If null, no user was associated with this invoice.
     * @return self
     */
    ...
    /**
     * @param float|null Percentage of discount this user received on this invoice. This discount is already calculated in the prices.
     * @return self
     */
    ...
    /**
     * @param string|null Link to user associated with this invoice.
     * @return self
     */
