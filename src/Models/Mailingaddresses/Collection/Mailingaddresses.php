...
namespace JacobDeKeizer\Ccv\Models\Mailingaddresses\Collection;
...
class Mailingaddresses implements Model
{
    ...
    /**
     * @var \JacobDeKeizer\Ccv\Models\Mailingaddresses\Resource\Mailingaddresses[] Array with collection items
     */
    private $items;
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Mailingaddresses\Resource\Mailingaddresses[] Array with collection items
     */
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Mailingaddresses\Resource\Mailingaddresses[] $items Array with collection items
     * @return self
     */
    ...
    protected function convertFromArrayData(string $key, $value)
    {
        if ($key === 'items') {
            ...
            foreach ($value as $item) {
                $items[] = \JacobDeKeizer\Ccv\Models\Mailingaddresses\Resource\Mailingaddresses::fromArray($item);
            }
