...
class Paymethod implements Model
{
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Internal\Entity\Apppsp\Paymethod\Child\Issuers[]|null $issuers Collection of Issuers
     * @return self
     */
    ...
    protected function convertFromArrayData(string $key, $value)
    {
        if ($key === 'issuers') {
            ...
            foreach ($value as $item) {
                $items[] = \JacobDeKeizer\Ccv\Models\Internal\Entity\Apppsp\Paymethod\Child\Issuers::fromArray($item);
            }
