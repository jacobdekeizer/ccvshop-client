...
class Post implements Model
{
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Internal\Entity\Orderrow\Input\Input[] $orderrows Describes a collection of order rows. If a product_id is provided the properties will be populated with product data. If you wish to overrule this data just add the property to the payload.
     * @return self
     */
