...
namespace JacobDeKeizer\Ccv\Models\Productkeywords\Resource;
...
class Productkeywords implements Model
{
     ...
     */
    public function getParent(): ?\JacobDeKeizer\Ccv\Models\Productkeywords\Child\Resource\ParentItem
    {
        return $this->parent;
    }
     ...
     * @return self
     */
    public function setParent(?\JacobDeKeizer\Ccv\Models\Productkeywords\Child\Resource\ParentItem $parent): self
    {
        $this->parent = $parent;
