...
namespace JacobDeKeizer\Ccv\Models\Categories\Collection;
...
class Categories implements Model
{
    ...
    /**
     * @var \JacobDeKeizer\Ccv\Models\Categories\Resource\Categories[] Array with collection items
     */
    private $items;
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Categories\Resource\Categories[] Array with collection items
     */
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Categories\Resource\Categories[] $items Array with collection items
     * @return self
     */
    ...
    protected function convertFromArrayData(string $key, $value)
    {
        if ($key === 'items') {
            ...
            foreach ($value as $item) {
                $items[] = \JacobDeKeizer\Ccv\Models\Categories\Resource\Categories::fromArray($item);
            }
