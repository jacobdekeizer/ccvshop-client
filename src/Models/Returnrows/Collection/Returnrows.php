...
namespace JacobDeKeizer\Ccv\Models\Returnrows\Collection;
...
class Returnrows implements Model
{
    ...
    /**
     * @var \JacobDeKeizer\Ccv\Models\Returnrows\Resource\Returnrows[] Array with collection items
     */
    private $items;
    ...
    /**
     * @return \JacobDeKeizer\Ccv\Models\Returnrows\Resource\Returnrows[] Array with collection items
     */
    ...
    /**
     * @param \JacobDeKeizer\Ccv\Models\Returnrows\Resource\Returnrows[] $items Array with collection items
     * @return self
     */
    ...
    protected function convertFromArrayData(string $key, $value)
    {
        if ($key === 'items') {
            ...
            foreach ($value as $item) {
                $items[] = \JacobDeKeizer\Ccv\Models\Returnrows\Resource\Returnrows::fromArray($item);
            }
